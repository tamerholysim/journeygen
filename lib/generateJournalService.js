...
async function generateJournal({ topic, backgroundText = '' }) {
  ...
  systemPrompt += `
You are a journal writer. Your task is to generate a complete guided journal based on the user's topic from within the lens of the framework in your background text. The journal must include:
